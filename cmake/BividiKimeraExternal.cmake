...
# This module is included only when BIVIDI_WITH_KIMERA_VIO=ON.
...
if(NOT DEFINED BIVIDI_KIMERA_VIO_REVISION OR BIVIDI_KIMERA_VIO_REVISION STREQUAL "")
    message(FATAL_ERROR
        "BIVIDI_WITH_KIMERA_VIO=ON requires BIVIDI_KIMERA_VIO_REVISION=${BIVIDI_KIMERA_VIO_PINNED_REVISION}")
endif()
