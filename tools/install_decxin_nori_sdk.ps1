...
if ([string]::IsNullOrWhiteSpace($Archive)) {
    if (-not (Test-Path $BundledArchive)) {
        throw "Tracked DECXIN/Nori vendor bundle is missing: $BundledArchive. Pull main again; the normal workflow is clone-contained and does not require a separate vendor download."
    }
